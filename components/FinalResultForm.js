...
export default function FinalResultForm({ userId, dietName, onSubmissionSuccess }) {
  ...
  return (
    <div className="flex flex-col gap-6 items-center ">
      ...
      <div className="flex flex-col items-center">
        <label htmlFor="finalWeight" className="block textGradient dark:text-blue-500 text-sm sm:text-base font-bold mb-2">
          Final Weight (kg)
        </label>
        <input
          type="number"
      ...
      <div className="flex flex-col gap-6 sm:flex-row">
        {/* Pros Selection */}
      <fieldset>
        <legend className="block textGradient dark:text-blue-500 text-base sm:text-lg font-bold">Pros of the Diet Plan:</legend>
      ...
      {/* Cons Selection */}
      <fieldset>
        <legend className="block textGradient dark:text-blue-500 text-base sm:text-lg font-bold">Cons of the Diet Plan:</legend>
    ...
    <h2 className="text-base sm:text-lg text-center font-bold textGradient dark:text-blue-500">Any reflection on this diet experience?</h2>
    <textarea
